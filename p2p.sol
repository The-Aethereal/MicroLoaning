...
contract MicroLoan {
    ...
    function _transferCollateral(address token, address /*from*/, address to, uint256 amount
) private {
    ...
    // --- NEW HELPER FUNCTION ---
    // Returns all loan IDs where the loan is still unsettled (REQUESTED or FUNDED)
